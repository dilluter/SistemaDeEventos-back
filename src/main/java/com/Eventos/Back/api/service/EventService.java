...
public class EventService {
    ...
    public List<EventResponseDTO> getUpcomingEvents(int page, int size){
        ...
        return eventsPage.map(event -> new EventResponseDTO(event.getId(), event.getTitle(), event.getDescription(), event.getDate(), "", "", event.isRemote(), event.getEventUrl(), event.getImgUrl()))
                .stream().toList();
    }
